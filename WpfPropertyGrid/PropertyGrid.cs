  ...
  public partial class PropertyGrid : Control, INotifyPropertyChanged
  {
    ...
    private IEnumerable<PropertyItem> CollectProperties(object[] components)
    {
      ...
      */
      ...
      {
          if (null != PropertyFilterType)
          {
              if (IsPropertyContainAttribute(propertyDescriptor, PropertyFilterType))
              {
    ...
    private bool IsPropertyContainAttribute(PropertyDescriptor property, Type attrType)
    {
